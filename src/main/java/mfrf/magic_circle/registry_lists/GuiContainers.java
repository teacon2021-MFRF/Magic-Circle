...
public class GuiContainers {
    ...
    public static final RegistryObject<ContainerType<ResearchTableContainer>> RESEARCH_TABLE_CONTAINER = REGISTER.register("research_table_container",
            () -> IForgeContainerType.create(
                    (windowId, inv, data) -> new ResearchTableContainer(windowId, inv, data.readBlockPos(), DistExecutor.safeRunForDist(() -> () -> Minecraft.getInstance().level, () -> () -> null), PlayerKnowledges.deserializeNBT(data.readAnySizeNbt()))));
    public static final RegistryObject<ContainerType<AssemblyTableContainer>> ASSEMBLY_TABLE_CONTAINER = REGISTER.register("magic_model_assembly_table_container",
            () -> IForgeContainerType.create(
                    (windowId, inv, data) -> new AssemblyTableContainer(windowId, inv, data.readBlockPos(), DistExecutor.safeRunForDist(() -> () -> Minecraft.getInstance().level, () -> () -> null))));
    public static final RegistryObject<ContainerType<EngraverTableContainer>> ENGRAVER_TABLE_CONTAINER = REGISTER.register("engraver_table_container",
            () -> IForgeContainerType.create(
                    (windowId, inv, data) -> new EngraverTableContainer(windowId, inv, data.readBlockPos(), DistExecutor.safeRunForDist(() -> () -> Minecraft.getInstance().level, () -> () -> null))));
}

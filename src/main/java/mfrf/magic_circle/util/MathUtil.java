...
public class MathUtil {
    ...
    public static Vector3f RotationPoint(Vector3f point, float angleX, float angleY, float angleZ) {
        return new Vector3f(
                ...
                (float) (point.getY() * sin(angleX) * cos(angleY) + sin(angleX) * sin(angleY) * sin(angleZ) + cos(angleX) * cos(angleZ) + sin(angleX) * sin(angleY) * cos(angleZ) - cos(angleX) * sin(angleZ)),
                (float) (point.getZ() * -sin(angleY) + cos(angleY) * sin(angleZ) + cos(angleY) * cos(angleZ))
        );
    }

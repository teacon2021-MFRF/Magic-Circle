...
public class MagesBoots extends MagesArmorBase {
    public MagesBoots(Properties p_i48534_3_, EffectiveItemContainer.Slot[] slots) {
        super(EquipmentSlotType.FEET, p_i48534_3_, new MagicalItemSimpleImplement(new EffectiveItemContainer(slots), MATERIAL.getManaCapacity(), MATERIAL.getScaleCapacityIfPrimed(), (int) MATERIAL.getManaCapacity(), MATERIAL.getManaRecovery(), MATERIAL.getScaleRecoverIfPrimed(), null));
    }

...
public class MagesCloak extends MagesArmorBase {
    public MagesCloak(Properties p_i48534_3_, EffectiveItemContainer.Slot[] slots) {
        super(EquipmentSlotType.CHEST, p_i48534_3_, new MagicalItemSimpleImplement(new EffectiveItemContainer(slots), MATERIAL.getManaCapacity(), MATERIAL.getScaleCapacityIfPrimed(), (int) MATERIAL.getManaCapacity(), MATERIAL.getManaRecovery(), MATERIAL.getScaleRecoverIfPrimed(), null));
    }
}

...
public class ModelMagicCircle extends EntityModel<EntityMagicCircle> {
    @Override
    public void setupAnim(EntityMagicCircle entityMagicCircle, float v, float v1, float v2, float v3, float v4) {

...
// public int numCols;
//
// public ObjectMatrixNbyN(MatrixObjectComponent[] data, int numRows, int
// numCols) {
// this.data = data;
...
// MatrixObjectComponent[] matrixObjectComponents = new
// MatrixObjectComponent[numCols];
